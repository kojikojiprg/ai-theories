...
Notebookをまとめた記事は、[Zenn](https://zenn.dev/kojikojiprg/books/ai-theories-roadmap)にて公開しています。
...
- 学習・実験 / Training & experiments:  
  Google Colab 無料枠(T4 GPU など)/ Google Colab free tier (T4 GPU, etc.)
