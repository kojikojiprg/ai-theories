...
| 002 | Transformer Block             | 01_foundations        | 001                      | 残差接続(Residual Connection)、Layer Normalization、FFN(Feed-Forward Network)、Pre-LN / Post-LN の違いを扱い、001 で実装した Multi-Head Attention をブロックに組み込む                                                     | (未作成 / TBD)                                                                  |
